...
function checkEvt(){
    var evTypep=window.performance.getEntriesByType("navigation")[0].type;
       if (evTypep=='reload'){
           if(window.location.href = 'http://localhost/sistem-pergudangan-mba/sistem/data_barang.php?pesan=tambah') {
            window.location.replace("http://localhost/sistem-pergudangan-mba/sistem/data_barang.php");
           }
           else if(window.location.href = 'http://localhost/sistem-pergudangan-mba/sistem/data_barang.php?pesan=edit') {
            window.location.replace("http://localhost/sistem-pergudangan-mba/sistem/data_barang.php");
           }
           else if(window.location.href = 'http://localhost/sistem-pergudangan-mba/sistem/data_barang.php?pesan=edit') {
            window.location.replace("http://localhost/sistem-pergudangan-mba/sistem/data_barang.php");
